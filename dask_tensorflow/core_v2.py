...
def start_and_attach_server(spec: tf.train.ClusterSpec, job_name=None,
                            task_index=None, dask_worker=None):
    assert dask_worker is not None, 'Dask worker was not initialized correctly.'
    os.environ["TF_CONFIG"] = json.dumps({'cluster': spec.as_dict(),
